 ...
 * The impulse itself holds a list of the objects that need to be notified.
 *
 * This is a specialised @c impulse class to support impulses that have no
 * arguments.
 *
 */
template<>
class MUDLIB_CORE_API impulse<void>: public basic_impulse
{
public:
    /**
     * @brief Constructor
